#!/bin/bash
# 解析crash文件
# Example sh symbolicate.sh Crasher.crash Example/Crasher.app.dsym > Crasher_Symbolicated.log
# 或者 sh symbolicate.sh Crasher.crash Example/Crasher.app > Crasher_Symbolicated.log
